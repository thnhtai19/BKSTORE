<div class="bg-custom-background border-b text-black p-4 sticky top-0 z-50">
    <div class="container max-w-screen-1200 mx-auto flex items-center justify-between">
        ...
        <div class="flex items-center mx-4 flex-1 justify-center">
            <input 
                type="text" 
                placeholder="Tìm kiếm sản phẩm..." 
                class="border rounded-l-md p-2 h-10 w-4/6 focus:outline-none" 
            >
        ...
        <div id="avatar-container" class="flex items-center gap-1">
            ...
            <img src="https://ui-avatars.com/api/?background=random&name=Thanh+Tai" alt="User Avatar" class="w-8 h-8 rounded-full cursor-pointer ml-3 hidden md:block" id="avatar">
        </div>
    </div>
</div>
